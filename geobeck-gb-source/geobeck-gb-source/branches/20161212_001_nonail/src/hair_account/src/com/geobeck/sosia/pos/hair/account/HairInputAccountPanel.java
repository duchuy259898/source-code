...
//        txtNowRemainValue.setText(String.valueOf(totalValue));
    ...
    private void initComponents() {
        ...
        products.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "区分", "分類", "商品/技術名/コース名", "単価", "数量", "金額", "割引", "合計", "按分名", "ﾎﾟｲﾝﾄ", "割合", "残回数", "NO", "担当者", "指名", "AP", "宅送", "施術台", "削除"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Double.class, java.lang.String.class, java.lang.Object.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Object.class, java.lang.String.class
            };
            boolean[] canEdit = new boolean [] {
                false, false, false, false, true, true, true, false, false, true, true, false, true, true, true, true, false, true, true
            };
        ...
        productsModel.getColumn(4).setCellEditor(new DoubleCellEditor(new JTextField()));
        ...
        */
        ...
        jLabel13.setBounds(0, 140, 192, 13);

        jLabel5.setText("※明細割引後の合計金額からの割引となります。");
        jPanel7.add(jLabel5);
        jLabel5.setBounds(0, 160, 235, 13);
        ...
        jLabel17.setBounds(490, 46, 110, 16);
        ...
        jLabel16.setBounds(98, 186, 269, 13);
        ...
        opeMinuteLabel.setBounds(90, 0, 12, 20);

        opeSecondLabel.setText("秒");
        opeTimePanel.add(opeSecondLabel);
        opeSecondLabel.setBounds(140, 0, 12, 20);
...
//            }
    ...
    private JComboBox getStaffComboBox(Integer staffID, Integer shopCategoryID) {
        ...
        MstStaff.addStaffDataToJComboBox(con,staffCombo,shopCategoryID,ia.getShop().getShopID());
        //IVS_LVTu end edit 2015/06/16 #37295
...
//        products.getColumnModel().getColumn(16).setResizable(false);
        ...
        products.getColumnModel().getColumn(12).setPreferredWidth(60);
        products.getColumnModel().getColumn(13).setPreferredWidth(80 + bedWidth3);                      // 担当者
        products.getColumnModel().getColumn(14).setPreferredWidth(28);		// 指名
        products.getColumnModel().getColumn(15).setPreferredWidth(28);		// アプローチ
        products.getColumnModel().getColumn(16).setPreferredWidth(28);          // 宅送  
        products.getColumnModel().getColumn(17).setPreferredWidth(70);		// 施術台
        products.getColumnModel().getColumn(18).setPreferredWidth(40);		// 削除
...
//		shop.setVisible(false);
    ...
    private void initProducts() {
        ...
        products.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                    "区分", "分類", "技術/商品/コース名", "単価", "数量", "金額", "割引", "合計", "按分名", "ﾎﾟｲﾝﾄ", "割合", "残回数","NO", "担当者", "指名", "AP", "宅送", "施術台", "削除"
                }) {
            Class[] types = new Class[]{
        ...
        TableColumnModel productsModel = products.getColumnModel();
        productsModel.getColumn(3).setCellEditor(new DoubleCellEditor(new JTextField()));
        productsModel.getColumn(4).setCellEditor(new DoubleCellEditor(new JTextField()));//数量
...
//        }
    ...
    private void addProductRow(DataSalesDetail dsd, boolean lordFlg, boolean isCustomerDisplayCalculate) {
        ...
        model.addRow(new Object[]{
                    ...
                    dsd.getProductDivision() == 3 ? 0 : ia.getAccountSetting().getDisplayValue(dsd.getProductValue(), ia.getTaxRate()),
                    ...
                    //Luc start edit 20150527 ticket 37040
                    ia.getAccountSetting().getDisplayValue(dsd.getProductValue(), ia.getTaxRate()),
                    ...
                    ia.getAccountSetting().getDisplayValue(dsd.getValue(),dsd.getProductNum().longValue(), dsd.getDiscountValue(), ia.getTaxRate()),
                    //Luc end  edit 20150527 ticket 37040
                    getNullField(),
                    getNullField(),
                    getNullField(),
        ...
        //調査用ろぐ
        SystemInfo.getLogger().log(Level.INFO, "売上明細：" + mp.getProductClass().getProductClassName() + " : " + mp.getProductName());
    ...
    private void addConsumptionCourseRow(DataSalesDetail dsd, boolean lordFlg) {
        ...
        model.addRow(new Object[]{
                    ...
                    ia.getAccountSetting().getDisplayValue(dsd.getProductValue(), ia.getTaxRate()),
                    dsd.getDiscount(),
                    ia.getAccountSetting().getDisplayValue(dsd.getValueForConsumption(), dsd.getDiscountValue(), ia.getTaxRate()),
                    getNullField(),
                    getNullField(),
                    getNullField(),
                            ...
                            if (courseMap.containsKey(dsd.getTmpContractNo())) {
                                ...
                                for (DataSalesDetail d : ia.getSales()) {
                                    if (d.getConsumptionCourse() != null
                                        ...
                                        Double balance =  new Double(num-use).doubleValue();
                                ...
                                for (int i = 0; i < products.getRowCount(); i++) {
                                    if (products.getValueAt(i, 2) instanceof ConsumptionCourse) {
                                        ...
                                        if (dsd.getTmpContractNo().equals(c.getTmpContractNo())) {
                                            ...
                                            long price = new BigDecimal(Double.valueOf(products.getValueAt(row, 5).toString())).divide(new BigDecimal(Double.valueOf(products.getValueAt(row, col).toString())), 0, RoundingMode.UP).longValue();
                                            c.setPrice(price);
                                            products.setValueAt(c, i, 2);
                                            products.setValueAt(c.getConsumptionRestNum(), i, restNumCol);
                                            
                                            products.setValueAt(ia.getAccountSetting().getDisplayValue(target.getProductValue(), ia.getTaxRate()), i, 3);
                                            products.setValueAt(ia.getAccountSetting().getDisplayValue(target.getProductValue(), ia.getTaxRate()), i, 5);
                                            products.setValueAt(ia.getAccountSetting().getDisplayValue(target.getValueForConsumption(), target.getDiscountValue(), ia.getTaxRate()), i, 7);
                                            break;
                                        }
                                    }
                                }
                        ...
                        if (courseMap.containsKey(dsd.getTmpContractNo())) {
                            ...
                            for (int i = 0; i < products.getRowCount(); i++) {
                                if (products.getValueAt(i, 2) instanceof ConsumptionCourse) {
                                    ConsumptionCourse c = (ConsumptionCourse) products.getValueAt(i, 2);
                                    if (dsd.getTmpContractNo().equals(c.getTmpContractNo())) {
                                        long price = new BigDecimal(Double.valueOf(products.getValueAt(row, col).toString())).divide(new BigDecimal(Double.valueOf(products.getValueAt(row, 4).toString())), 0, RoundingMode.UP).longValue();
                                        c.setPrice(price);
                                        products.setValueAt(c, i, 2);
                                        products.setValueAt(ia.getAccountSetting().getDisplayValue(target.getProductValue(), ia.getTaxRate()), i, 3);
                                        products.setValueAt(ia.getAccountSetting().getDisplayValue(target.getProductValue(), ia.getTaxRate()), i, 5);
            ...
            if (getProductsIndex(1) == null) {
                ...
                if (ia.getAccountSetting().getDiscountType() == 1
                    ...
                    ia.getSales().get(index).setDiscountValue(
                            ia.getAccountSetting().getDiscountValue(temp, discount, ia.getTaxRate()));
                }
            }
...
//                }
                ...
                if (conCourse.getContractNo() == null) {
                    reservationNum = 0;
                    consumptionNum = conCourse.getNum();
                } else {
                    ...
                    consumptionNum = getTotalRestNumOfCourse(ia.getSales().getSlipNo(), ia.getSales().getCustomer().getCustomerID(), conCourse.getCourseId(), conCourse.getContractShopId(), conCourse.getContractNo(), conCourse.getContractDetailNo());
                }
