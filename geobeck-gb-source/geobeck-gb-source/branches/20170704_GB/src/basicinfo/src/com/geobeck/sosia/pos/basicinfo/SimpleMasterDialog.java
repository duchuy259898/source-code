/*
 * SimpleMasterDialog.java
 *
 * Created on 2012/01/28, 11:24
 */
 ...
 * @author  katagiri
 */
public class SimpleMasterDialog extends com.geobeck.sosia.pos.swing.AbstractImagePanelEx
{
	//IVS_LTHieu add start 20140812 MASHU_コース統合
        private String mstName = null;
        //IVS_LTHieu add end 20140812 MASHU_コース統合
	/** Creates new form SimpleMasterDialog */
	public SimpleMasterDialog(
                String masterName,
                String tableName,
                String idColName,
                String nameColName,
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, closeButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 92, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
	...
	{//GEN-HEADEREND:event_renewButtonActionPerformed
		//IVS_LTHieu modify start 20140812 MASHU_コース統合
                if(mstName == "コース統合分類")
                {
                    if(this.checkInputModified())
                    {
                            this.regist(false);
                    }
                }
                ...
                //IVS_LTHieu modify end 20140812 MASHU_コース統合
	 ...
	 * @return true - ＯＫ
	 */
        private boolean checkInputModified()
        {
