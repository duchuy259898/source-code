...
public class OutputExcelDialog extends javax.swing.JDialog {
    ...
    public boolean getIsCustomerNo_0() {
        return isCustomerNo_0;
    }

    public void setIsCustomerNo_0(boolean isCustomerNo_0) {
        this.isCustomerNo_0 = isCustomerNo_0;
    }
    ...
    private void btnOutputAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOutputAccountActionPerformed
        ...
        //IVS_LVTU start add 2017/04/22 #61616 [gb]条件検索でNOT検索の追加及び非会員の精算情報を出力したい
        //精算情報EXCEL/CSV出力時に非会員データを含めるかダイアログを表示する
        int rs = JOptionPane.showConfirmDialog(this, "非会員（顧客No.0）の精算情報も出力しますか？", "Excel出力", JOptionPane.YES_NO_OPTION);
        if (rs == JOptionPane.YES_OPTION) {
            this.setIsCustomerNo_0(true);
        } else {
            this.setIsCustomerNo_0(false);
        }
        //IVS_LVTU end add 2017/04/22 #61616 [gb]条件検索でNOT検索の追加及び非会員の精算情報を出力したい
        if (!flgCSV) {
            this.setVisible(false);
            ...
            outPutFileString = getSaveCSVFileName("条件検索_精算情報");
    ...
    private void btnOutputCustomerInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOutputCustomerInfoActionPerformed
        ...
        if (!flgCSV) {
            ...
            outPutFileString = getSaveCSVFileName("条件検索_顧客情報");
            if(outPutFileString!=null) {
               this.setVisible(false); 
            }
        }
