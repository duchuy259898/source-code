...
public class ReservationStatusPanel extends com.geobeck.sosia.pos.swing.AbstractImagePanelEx implements HairInputAccountOpener
{
    ...
    private void initComponents() {
        ...
        status.setFont(new java.awt.Font("MS UI Gothic", 1, 12));
        ...
        reservation.getTableHeader().addMouseListener(
            ...
            stay.getTableHeader().addMouseListener(
                ...
                statusPanelLayout.setHorizontalGroup(
                    ...
                    .add(statusScroll, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 813, Short.MAX_VALUE)
                );
                ...
                sales.setModel(new javax.swing.table.DefaultTableModel(
                    ...
                    new String [] {
                        "伝票No.", "顧客No.", "顧客", "来店回数", "主担当者", "指名", "技術", "商品", "明細割引", "全体割引", "請求金額", "消費税"
                    }
                ) {
                    Class[] types = new Class [] {
                        java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
                ...
                sales.getTableHeader().addMouseListener(
                    ...
                    reservationCntLabel.setFont(new java.awt.Font("MS UI Gothic", 1, 12));
                    ...
                    zaitenCntLabel.setFont(new java.awt.Font("MS UI Gothic", 1, 12));
                    ...
                    taitenCntLabel.setFont(new java.awt.Font("MS UI Gothic", 1, 12));
                    ...
                    totalCntLabel.setFont(new java.awt.Font("MS UI Gothic", 1, 12));
                    ...
                    layout.setVerticalGroup(
                        ...
                        .add(layout.createSequentialGroup()
                            ...
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(status, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 514, Short.MAX_VALUE)
                            .addContainerGap())
                    );
...
//				dr.getSlipNo() > 0 ? dr.getTechnicClassContractedNameList() : dr.getTechnicClassContractedName(),
	...
	private void showSales()
	{
		...
		{
			model.addRow(new Object[]{  sd.getSlipNo(),
	...
	private void showSalesTotal()
	{
		...
		salesTotal.setValueAt(rs.getTotal().getDiscount(), 0, 2);
		salesTotal.setValueAt(rs.getTotal().getOverallDiscount(), 0, 3);
//		salesTotal.setValueAt(rs.getTotal().getTotal(), 0, 4);
		salesTotal.setValueAt(rs.getTotal().getTotalValue(), 0, 4);
		salesTotal.setValueAt(rs.getTotal().getTax(), 0, 5);
	}
...
//            System.out.println("shop = " + this.getSelectedShop());
	...
	{
            //データが選択されていない場合、処理を抜ける
            if(sales.getSelectedRowCount() <= 0) return;
	...
	public void setDate(java.util.Date d){
        ...
        private void printReservationList() {
            ...
            for (int i = 0; i < reservation.getRowCount(); i++) {
                ...
                jx.setValue(8, row, (Integer)reservation.getValueAt(i, 8));
