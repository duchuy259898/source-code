...
import com.geobeck.sosia.pos.account.BillsListPanel;
...
import com.geobeck.sosia.pos.hair.data.member.DataTransferHistory;
...
public class MstCustomerPanel extends com.geobeck.sosia.pos.swing.AbstractImagePanelEx {
    ...
    //請求・結果情報ヘッダ
    DataTransferHistory                  dataTransferHistory              = new DataTransferHistory();
...
// 2017/01/08 顧客メモ ADD END
    //IVS start add 2020/04/01 口座振替連携
    private boolean isTransferHistoryTabLoaded = false;
    //IVS end add 2020/04/01 口座振替連携
...
//    private int tabProposalIndex = 3;
    ...
    //口座振替履歴
    private int tabTransferHistoryIndex = 5;
    
    //DM・メール履歴
//    private int tabDMMailIndex = 4;
//    private int tabDMMailIndex = 5;
      private int tabDMMailIndex = 6;
    ...
    //IVS_LVTu start add 2017/10/31 #28923 [gb]予約キャンセル管理機能の実装
    /**
     * 店舗一覧
     */
    private ArrayList<MstShop> shopList = new ArrayList<MstShop>();
    //IVS_LVTu end add 2017/10/31 #28923 [gb]予約キャンセル管理機能の実装
...
// 2017/01/02 顧客メモ ADD END
        ...
        // 来店カルテ使用店舗のみQRコード表示ボタンを表示 20170413 add #61376
        this.setQrDisplayButtonVisible();
        ...
        if(!shop.getShopID().equals(0)) {
            if(shop.getCourseFlag() != null && shop.getCourseFlag().equals(0) )
            {
                ...
                tabTransferHistoryIndex = tabTransferHistoryIndex - 1;
...
// 2017/01/08 顧客メモ ADD END
        isTransferHistoryTabLoaded = false;
        ...
        //mst_system.use_account_transfer=trueの場合に表示 
        if (!SystemInfo.getSetteing().isUseAccountTransfer()) {
            jTabbedPane1.remove(tabTransferHistory);
            tabDMMailIndex = tabDMMailIndex -1;
        }
        //IVS_LVTu end add 2015/11/23 New request #44111
        ...
        //IVS_LVTu start edit 2017/10/31 #28923 [gb]予約キャンセル管理機能の実装
        this.loadShopList();
        
        //IVS_LVTu start delete 2017/10/23 #28526 [gb]顧客情報：来店情報タブ＞キャンセルタブを復活させる
        //IVS_LVTu start add 2017/09/27 #26786 [gb]顧客情報：来店情報タブ＞キャンセルタブを非表示にする
        if (!this.isExistsUseCancel()) {
            salesInfoTabbedPane.remove(cancel);
        }
        //IVS_LVTu end edit 2017/10/31 #28923 [gb]予約キャンセル管理機能の実装
        //IVS_LVTu end add 2019/09/27 #26786 [gb]顧客情報：来店情報タブ＞キャンセルタブを非表示にする
        //IVS_LVTu end delete 2017/10/23 #28526 [gb]顧客情報：来店情報タブ＞キャンセルタブを復活させる
    ...
    public MstCustomerPanel(Integer customerID, boolean isReadOnly, boolean dispRenew, boolean isCloseButtonEnable) {
        ...
        // IVS start add 20220907 カスタマイズ箇所・３：顧客情報＞基本情報
        reservationTooltip.setVisible(false);
        if (SystemInfo.getDatabase().equals("pos_hair_sunaocl")) {
            reservationTooltip.setIcon(SystemInfo.getImageIcon("/button/common/icon_info.png"));
            getReservationToolTip(customerID);
            reservationTooltip.setVisible(true);
        }
        // IVS end add 20220907 カスタマイズ箇所・３：顧客情報＞基本情報
    ...
    private void initComponents() {
        ...
        reservationTooltip = new javax.swing.JLabel();
    ...
    tabTransferHistory = new javax.swing.JPanel();
    panelTransferHistory = new javax.swing.JPanel();
    transferHistoryScrollPane = new javax.swing.JScrollPane();
    tbTransferHistory = new com.geobeck.swing.JTableEx();
    paneTransferHistoryInfo = new javax.swing.JPanel();
    lblbAccountInfo = new javax.swing.JLabel();
    lbCustomerNameTransfer = new javax.swing.JLabel();
    txtCustomerNoTransfer = new javax.swing.JLabel();
    lbCustomerNoTransfer = new javax.swing.JLabel();
    txtCustomerNameTransfer = new javax.swing.JLabel();
    ...
    qrDisplayButton.setEnabled(false);
    ...
    registPanelLayout.setHorizontalGroup(
        ...
        .add(org.jdesktop.layout.GroupLayout.TRAILING, registPanelLayout.createSequentialGroup()
            ...
            .add(qrDisplayButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 100, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    ...
    registPanelLayout.setVerticalGroup(
        ...
        .add(org.jdesktop.layout.GroupLayout.TRAILING, qrDisplayButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    );
    ...
    customerNamePanelLayout.setHorizontalGroup(
        ...
        .add(customerNamePanelLayout.createSequentialGroup()
            ...
            .add(customerNamePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(customerName2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 120, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(customerKana2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 120, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .add(5, 5, 5)
            .add(reservationTooltip))
    );
    customerNamePanelLayout.setVerticalGroup(
        ...
        .add(customerNamePanelLayout.createSequentialGroup()
            .add(customerNamePanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                ...
                .add(reservationTooltip, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 24, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .add(0, 0, 0)
    ...
    yearUnit.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "西暦" }));
    ...
    cancelLayout.setHorizontalGroup(
        ...
        .add(cancelLayout.createSequentialGroup()
            .add(1, 1, 1)
            .add(cancelsScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE))
    );
    cancelLayout.setVerticalGroup(
        cancelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(cancelLayout.createSequentialGroup()
            .addContainerGap()
            .add(cancelsScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 461, Short.MAX_VALUE)
            .add(0, 0, 0))
    );
    ...
    techInfoPanelLayout.setVerticalGroup(
        ...
        .add(techInfoPanelLayout.createSequentialGroup()
            .addContainerGap()
            .add(techTableScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 461, Short.MAX_VALUE))
    );
    ...
    itemInfoPanelLayout.setVerticalGroup(
        ...
        .add(itemInfoPanelLayout.createSequentialGroup()
            .addContainerGap()
            .add(itemTableScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 461, Short.MAX_VALUE))
    );
    ...
    visitedMemoPanelLayout.setVerticalGroup(
        ...
        .add(org.jdesktop.layout.GroupLayout.TRAILING, visitedMemoPanelLayout.createSequentialGroup()
            ...
            .add(visitedMemoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                ...
                .add(visitedMemoScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE))
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
    ...
    org.jdesktop.layout.GroupLayout pointInfoPanelLayout = new org.jdesktop.layout.GroupLayout(pointInfoPanel);
    pointInfoPanel.setLayout(pointInfoPanelLayout);
    pointInfoPanelLayout.setHorizontalGroup(
        pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(pointInfoPanelLayout.createSequentialGroup()
            .add(4, 4, 4)
            .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(pointInfoPanelLayout.createSequentialGroup()
                    ...
                    .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(pointInfoPanelLayout.createSequentialGroup()
                            .add(50, 50, 50)
                            .add(jLabel21, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 56, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .add(shopPoint, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 60, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(4, 4, 4)
                    .add(datePoint))
                .add(pointInfoPanelLayout.createSequentialGroup()
                    .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(pointInfoPanelLayout.createSequentialGroup()
                            .add(65, 65, 65)
                            .add(usePoint, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 65, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .add(jLabel22))
                    .add(12, 12, 12)
                    .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(pointInfoPanelLayout.createSequentialGroup()
                            .add(64, 64, 64)
                            .add(suppliedPoint, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 65, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .add(jLabel23))))
            .add(15, 15, 15)
            .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(pointAddButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 92, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(pointUpdateButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 92, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
        .add(pointTableScrollPane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 380, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    );
    pointInfoPanelLayout.setVerticalGroup(
        pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(pointInfoPanelLayout.createSequentialGroup()
            .add(10, 10, 10)
            .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(pointInfoPanelLayout.createSequentialGroup()
                    .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(jLabel20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 16, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(jLabel21, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 16, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(shopPoint, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 16, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(datePoint, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 16, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(6, 6, 6)
                    .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        ...
                        .add(pointInfoPanelLayout.createSequentialGroup()
                            .add(3, 3, 3)
                            .add(pointInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                .add(usePoint, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .add(pointInfoPanelLayout.createSequentialGroup()
                                    .add(3, 3, 3)
                                    .add(jLabel22))
                                .add(suppliedPoint, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))))
                .add(pointInfoPanelLayout.createSequentialGroup()
                    .add(pointAddButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 26, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(4, 4, 4)
                    .add(pointUpdateButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
            .add(2, 2, 2)
            .add(pointTableScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE)
            .add(0, 0, 0))
    );
    ...
    org.jdesktop.layout.GroupLayout prepaidInfoPanelLayout = new org.jdesktop.layout.GroupLayout(prepaidInfoPanel);
    prepaidInfoPanel.setLayout(prepaidInfoPanelLayout);
    prepaidInfoPanelLayout.setHorizontalGroup(
        prepaidInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(prepaidInfoPanelLayout.createSequentialGroup()
            .add(jLabel26, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 50, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .add(0, 0, 0)
            .add(currentPrepaid, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 60, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .add(0, 0, 0)
            .add(jLabel24, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        .add(prepaidTableScrollPane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 380, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    );
    prepaidInfoPanelLayout.setVerticalGroup(
        prepaidInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(prepaidInfoPanelLayout.createSequentialGroup()
            .add(5, 5, 5)
            .add(prepaidInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jLabel26, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(currentPrepaid, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(jLabel24, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .add(9, 9, 9)
            .add(prepaidTableScrollPane)
            .add(0, 0, 0))
    );
    ...
    jPanel3Layout.setVerticalGroup(
        ...
        .add(jPanel3Layout.createSequentialGroup()
            ...
            .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                .add(salesInfoTabbedPane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 500, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    ...
    memoRegistButton.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    feedListButton.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    panelTransferHistory.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
    panelTransferHistory.setOpaque(false);

    transferHistoryScrollPane.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
    transferHistoryScrollPane.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);

    tbTransferHistory.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
        },
        new String [] {
            "対象月", "口座振替日", "契約プラン", "請求金額","振替結果","店舗名","伝票No","回収処理","引落口座"
        }
    ) {
        Class[] types = new Class [] {
            java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Long.class, java.lang.String.class,java.lang.String.class,java.lang.Long.class,java.lang.Object.class,java.lang.String.class
        };
        boolean[] canEdit = new boolean [] {
    ...
    tbTransferHistory.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
    tbTransferHistory.setSelectionBackground(new java.awt.Color(220, 220, 220));
    tbTransferHistory.setSelectionForeground(new java.awt.Color(0, 0, 0));
    tbTransferHistory.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
    tbTransferHistory.getTableHeader().setReorderingAllowed(false);
    this.initAccountHistory();
    tbTransferHistory.setRowHeight(SystemInfo.TABLE_ROW_HEIGHT);
    SwingUtil.setJTableHeaderRenderer(tbTransferHistory, SystemInfo.getTableHeaderRenderer());
    //SelectTableCellRenderer.setSelectTableCellRenderer(tbTransferHistory);
    transferHistoryScrollPane.setViewportView(tbTransferHistory);
    tbTransferHistory.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);

    org.jdesktop.layout.GroupLayout panelTransferHistoryLayout = new org.jdesktop.layout.GroupLayout(panelTransferHistory);
    panelTransferHistory.setLayout(panelTransferHistoryLayout);
    panelTransferHistoryLayout.setHorizontalGroup(
        panelTransferHistoryLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(transferHistoryScrollPane)
    );
    panelTransferHistoryLayout.setVerticalGroup(
        panelTransferHistoryLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(transferHistoryScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 545, Short.MAX_VALUE)
    );

    lblbAccountInfo.setText("登録口座情報");

    lbCustomerNameTransfer.setText("氏名");

    txtCustomerNoTransfer.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
    txtCustomerNoTransfer.setPreferredSize(new java.awt.Dimension(39, 20));

    lbCustomerNoTransfer.setText("顧客No.");

    txtCustomerNameTransfer.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
    txtCustomerNameTransfer.setPreferredSize(new java.awt.Dimension(39, 20));

    org.jdesktop.layout.GroupLayout paneTransferHistoryInfoLayout = new org.jdesktop.layout.GroupLayout(paneTransferHistoryInfo);
    paneTransferHistoryInfo.setLayout(paneTransferHistoryInfoLayout);
    paneTransferHistoryInfoLayout.setHorizontalGroup(
        paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(paneTransferHistoryInfoLayout.createSequentialGroup()
            .addContainerGap()
            .add(paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                .add(lbCustomerNoTransfer, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 50, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(lbCustomerNameTransfer, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 54, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                .add(txtCustomerNameTransfer, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .add(txtCustomerNoTransfer, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 121, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .add(18, 18, 18)
            .add(lblbAccountInfo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 80, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(accountInfo, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 520, Short.MAX_VALUE)
            .addContainerGap())
    );
    paneTransferHistoryInfoLayout.setVerticalGroup(
        paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(paneTransferHistoryInfoLayout.createSequentialGroup()
            .addContainerGap()
            .add(paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(txtCustomerNoTransfer, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(lbCustomerNoTransfer, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .add(paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lblbAccountInfo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(accountInfo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(paneTransferHistoryInfoLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(lbCustomerNameTransfer, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(txtCustomerNameTransfer, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
            .addContainerGap())
    );

    org.jdesktop.layout.GroupLayout tabTransferHistoryLayout = new org.jdesktop.layout.GroupLayout(tabTransferHistory);
    tabTransferHistory.setLayout(tabTransferHistoryLayout);
    tabTransferHistoryLayout.setHorizontalGroup(
        tabTransferHistoryLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(org.jdesktop.layout.GroupLayout.TRAILING, paneTransferHistoryInfo, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        .add(tabTransferHistoryLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(tabTransferHistoryLayout.createSequentialGroup()
                .add(3, 3, 3)
                .add(panelTransferHistory, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .add(3, 3, 3)))
    );
    tabTransferHistoryLayout.setVerticalGroup(
        tabTransferHistoryLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(tabTransferHistoryLayout.createSequentialGroup()
            .add(0, 0, 0)
            .add(paneTransferHistoryInfo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .add(0, 0, 0))
        .add(tabTransferHistoryLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, tabTransferHistoryLayout.createSequentialGroup()
                .addContainerGap(66, Short.MAX_VALUE)
                .add(panelTransferHistory, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(47, 47, 47)))
    );

    jTabbedPane1.addTab("口座振替履歴", tabTransferHistory);
	...
	{                                                    
            ...
            if (sc.getSelectedCustomer() != null
				...
				jTabbedPane1.setSelectedIndex(tabGenaralIndex);
...
// 2017/01/08 顧客メモ ADD END
    ...
    private javax.swing.JLabel reservationTooltip;
    ...
    private javax.swing.JLabel lbCustomerNameTransfer;
    private javax.swing.JLabel lbCustomerNo;
    private javax.swing.JLabel lbCustomerNoTransfer;
    ...
    private javax.swing.JLabel lblbAccountInfo;
    ...
    private javax.swing.JPanel paneTransferHistoryInfo;
    private javax.swing.JPanel panelTransferHistory;
    ...
    private javax.swing.JPanel tabTransferHistory;
    ...
    private com.geobeck.swing.JTableEx tbTransferHistory;
    ...
    private javax.swing.JScrollPane transferHistoryScrollPane;
    private javax.swing.JLabel txtCustomerName;
    private javax.swing.JLabel txtCustomerNameTransfer;
    private javax.swing.JLabel txtCustomerNo;
    private javax.swing.JLabel txtCustomerNoTransfer;
...
// 2017/01/08 顧客メモ ADD END
    ...
    private void showData() {
        ...
        //An start add 20130125
        //IVS_LVTu start delete 2017/10/27 #28923 [gb]予約キャンセル管理機能の実装
        //this.setSelectedWebReservationFlag();
        //IVS_LVTu end delete 2017/10/27 #28923 [gb]予約キャンセル管理機能の実装
...
// 2017/01/08 顧客メモ ADD END
        //IVS start add 2020/04/01 口座振替連携
        if(jTabbedPane1.getSelectedComponent().equals(tabTransferHistory) && !isTransferHistoryTabLoaded) {
            this.loadDataAccountInfo();
            isTransferHistoryTabLoaded = true;
        }
        //IVS end add 2020/04/01 口座振替連携
...
//                    });
    ...
    public boolean getUpdateDataContractStatusSQL(DataContract dc, ConnectionWrapper con) throws SQLException
   {
    ...
    private void changeButtonEnabled(boolean enabled) {
        ...
        setQrDisplayButtonEnabled(enabled);
    }
...
//			return;
    ...
    private void setSelectedJob() {
        ...
        //IVS_LVTu start edit 2017/08/02 #13975 [gb]顧客情報の職業を登録するが再表示すると未選択状態になる
        for (MstJob mj : jobList) {
            if (mj != null && customer != null && customer.getJob() != null
                    && mj.getJobID().equals(customer.getJobID())) {
                job.setSelectedItem(mj);
            }
        }
        //IVS_LVTu end edit 2017/08/02 #13975 [gb]顧客情報の職業を登録するが再表示すると未選択状態になる
    }
...
// 2017/01/08 顧客メモ ADD END
    ...
    //IVS_LVTU start edit 2017/09/07 #25055 [gb]顧客情報画面 ポイントタブの数字が初期表示で見切れる
    private void initPointTableWidth() {
        pointTable.getColumnModel().getColumn(0).setPreferredWidth(100);
        pointTable.getColumnModel().getColumn(1).setPreferredWidth(79);
        pointTable.getColumnModel().getColumn(2).setPreferredWidth(90);
        pointTable.getColumnModel().getColumn(3).setPreferredWidth(90);
    }

    private void initPrepaidTableWidth() {
        prepaidTable.getColumnModel().getColumn(0).setPreferredWidth(100);
        prepaidTable.getColumnModel().getColumn(1).setPreferredWidth(79);
        prepaidTable.getColumnModel().getColumn(2).setPreferredWidth(90);
        prepaidTable.getColumnModel().getColumn(3).setPreferredWidth(90);
    }
    //IVS_LVTU end edit 2017/09/07 #25055 [gb]顧客情報画面 ポイントタブの数字が初期表示で見切れる
...
// 2017/01/08 顧客メモ ADD END
    ...
    //An start add 20130125
    //IVS_LVTu start edit 2017/10/27 #28923 [gb]予約キャンセル管理機能の実装
    private void initCancelColumn() {
        cancels.getColumnModel().getColumn(0).setPreferredWidth(80);     // 予約店舗
        cancels.getColumnModel().getColumn(1).setPreferredWidth(70);      // 予約日
        cancels.getColumnModel().getColumn(2).setPreferredWidth(50);      // WEB予約
        cancels.getColumnModel().getColumn(3).setPreferredWidth(50);      // 区分
        cancels.getColumnModel().getColumn(4).setPreferredWidth(70);      // 削除日
        ...
        cancels.getColumnModel().getColumn(2).setCellRenderer(cell0Render);
        cancels.getColumnModel().getColumn(3).setCellRenderer(cell0Render);
    }
    //IVS_LVTu end edit 2017/10/27 #28923 [gb]予約キャンセル管理機能の実装
    //An end add 20130125
...
//        contractCourseTable.getColumnModel().getColumn(12).setPreferredWidth(55);	//共有
    ...
    private void initAccountHistory() {
    	...
    	tbTransferHistory.getColumnModel().getColumn(0).setPreferredWidth(70);  
        tbTransferHistory.getColumnModel().getColumn(1).setPreferredWidth(70); 
        tbTransferHistory.getColumnModel().getColumn(2).setPreferredWidth(95);
        tbTransferHistory.getColumnModel().getColumn(3).setPreferredWidth(80);
        tbTransferHistory.getColumnModel().getColumn(4).setPreferredWidth(80);
        tbTransferHistory.getColumnModel().getColumn(5).setPreferredWidth(90);
        tbTransferHistory.getColumnModel().getColumn(6).setPreferredWidth(50);
        tbTransferHistory.getColumnModel().getColumn(7).setPreferredWidth(95);
        tbTransferHistory.getColumnModel().getColumn(8).setPreferredWidth(160);
        
        tbTransferHistory.getColumnModel().getColumn(7).setCellRenderer(cell0Render);
        
        tbTransferHistory.setDefaultRenderer(Object.class, new TableCellAlignRenderer(tbTransferHistory));
        tbTransferHistory.setDefaultRenderer(java.lang.String.class, new TableCellAlignRenderer(tbTransferHistory));
        tbTransferHistory.setDefaultRenderer(java.lang.Long.class, new TableCellAlignRenderer(tbTransferHistory));
    }
    //IVS end add 2020/04/01 口座振替連携
    //IVS_LVTu end add 2015/11/23 New request #44111
    /**
    ...
    private void showCancel() {
        ...
        sql.append("     ,coalesce(a.cancel_flg, 0) as cancel_flg");
        sql.append("     ,case ");
        sql.append("          when a.mobile_flag is not null then '●'");
        sql.append("          else ''");
        sql.append("     end as from_web");
        ...
        // IVS SANG START EDIT 20131103
        sql.append(" where a.customer_id =").append(SQLUtil.convertForSQL(customer.getCustomerID()));
        sql.append(" and c.reservation_detail_no =1");
        // IVS SANG START INSERT 20131103
        sql.append(" and a.delete_date is not null");
        // IVS SANG START INSERT 20131103
        sql.append(" order by c.reservation_datetime desc, a.reservation_no ");
        try {
            ResultSetWrapper rs = SystemInfo.getConnection().executeQuery(sql.toString());
            NumberFormat nf = NumberFormat.getInstance();
            while (rs.next()) {
                ...
                dr.setShop(ms);
                String strFromWeb = rs.getString("from_web");
                String strCancelFlag = "";
                if (dr.getCancelFlag() == 0) {
                    strCancelFlag = "取消";
                } else if (dr.getCancelFlag() == 1) {
                    strCancelFlag = "連絡有";
                } else if (dr.getCancelFlag() == 2) {
                    strCancelFlag = "無断";
                } else if (dr.getCancelFlag() == 3) {
                    strCancelFlag = "顧客取消";
                }
                dr.setDeleteDate(rs.getDate("delete_date"));
                model.addRow(new Object[]{
                            dr.getShop().getShopName(),
                            dr.getReserveDate() == null ? "" : String.format("%1$tY/%1$tm/%1$td", (dr.getReserveDate())),
                            strFromWeb,
                            strCancelFlag,
                            dr.getDeleteDate() == null ? "" : String.format("%1$tY/%1$tm/%1$td", (dr.getDeleteDate()))
                        });
            }
...
// 2017/01/02 顧客メモ ADD START
    ...
    * @param shop 店舗情報
    ...
    private void qrDisplay() {
        ...
        // 顧客IDを取得
        Integer karteCustomerID = customer.getCustomerID();
        
        if(karteCustomerID > 0 && karteCustomerID != null) {
            VisitKarteDialog.ShowDialog(parentFrame, karteCustomerID, this);
        }
    }
     ...
     * 20170413 add #61376
     */
    private void setQrDisplayButtonVisible() {
        qrDisplayButton.setVisible(SystemInfo.getUseVisitKarte());
        }
     ...
     * 20170413 add #61376
     */
    private void setQrDisplayButtonEnabled(boolean flag) {
        VisitKarteSetting vks = new VisitKarteSetting();
            
        if(flag) {
            qrDisplayButton.setEnabled(vks.isExists());
        }else {
    ...
    //IVS_LVTu start add 2017/10/31 #28923 [gb]予約キャンセル管理機能の実装
    /**
     * check shop use cancel flag.
     * @return
     */
    private boolean isExistsUseCancel() {
        if (shopList == null || shopList.size() == 0) {
            return false;
        }
       
        for (MstShop shop : shopList) {
            if (shop != null && shop.getShopID() != null &&
                    shop.getUseCancelFlag() == 1) {
                return true;
                }
        }
        return false;
   ...
   /**
    ...
    {
        if (this.getCustomer() == null || this.getCustomer().getCustomerID() == null) return;
        ...
        try
        {
                ...
                dataTransferHistory.loadByCustomer(con, this.getCustomer().getCustomerID());
        }
        catch(SQLException e)
        {
                SystemInfo.getLogger().log(Level.SEVERE, e.getLocalizedMessage(), e);
   ...
   {
       //顧客No.
        txtCustomerNoTransfer.setText(this.customer.getCustomerNo());
        //氏名
        txtCustomerNameTransfer.setText(this.customer.getFullCustomerName());
        //登録口座情報
        if (dataTransferHistory != null && dataTransferHistory.size() > 0) {
            StringBuilder strInfo = new StringBuilder();
            strInfo.append(dataTransferHistory.getDataAccountInfo().getBankName());
            strInfo.append("(");
            strInfo.append(dataTransferHistory.getDataAccountInfo().getBankCode());
            strInfo.append(")");
            strInfo.append("　");
            strInfo.append(dataTransferHistory.getDataAccountInfo().getBranchName());
            strInfo.append("(");
            strInfo.append(dataTransferHistory.getDataAccountInfo().getBranchCode());
            strInfo.append(")");
            strInfo.append("　");
            strInfo.append(DataAccountInfo.AccountType.getAccountType(Integer.parseInt(dataTransferHistory.getDataAccountInfo().getAccountType())).getText());
            strInfo.append("　");
            strInfo.append(dataTransferHistory.getDataAccountInfo().getAccountNumber().substring(0, 1)).append("******");
            strInfo.append("　");
            strInfo.append(dataTransferHistory.getDataAccountInfo().getAccountName());
            accountInfo.setText(strInfo.toString());
                             
            DefaultTableModel	model	=	(DefaultTableModel)tbTransferHistory.getModel();
            if (tbTransferHistory.getCellEditor() != null) {
                tbTransferHistory.getCellEditor().stopCellEditing();
            }
            //全行削除
            SwingUtil.clearTable(tbTransferHistory);
            for(DataTransferResult transferResult : dataTransferHistory)
            {
                 for(DataTransferResultDetail detail : transferResult)
                 {
                     Object[]	rowData	=	{   String.format("%1$tY年%1$tm月", transferResult.getTargetMonth()),
                                                         getTransferDate(transferResult),
                                                         detail.getPlanName(),
                                                         detail.getBillingAmount(),
                                                         detail,
                                                         detail.getMstShop().getShopName(),
                                                         detail.getSlipNo(),
                                                         detail.getResultCode() == null ? StringUtils.EMPTY : (detail.isShowCollectBill() ? getCollectButtonButton(detail.getCustomerID(), detail.getSlipNo()) : "済" ),
                                                         getInfoAccountDebit(detail)};
                     model.addRow(rowData);
                 }
                         }
            // 1行目を選択状態にする
            if (tbTransferHistory.getRowCount() > 0) {
                tbTransferHistory.addRowSelectionInterval(0, 0);
                    }
                }
    }
    ...
    * @return 
    */
   private String getTransferDate(DataTransferResult transferResult) {
       Calendar calendar = new java.util.GregorianCalendar(Integer.parseInt(transferResult.getTransferYear()),Integer.parseInt(transferResult.getTransferMonth()),Integer.parseInt(transferResult.getTransferDate()));
        
       return new SimpleDateFormat("yyyy/MM/dd").format(calendar.getTime());
        }
        
   private String getInfoAccountDebit(DataTransferResultDetail detail) {
        StringBuilder strInfo = new StringBuilder();

        strInfo.append(detail.getDataAccountInfo().getBankName());
        strInfo.append("　");
        strInfo.append(detail.getDataAccountInfo().getBranchName());
        strInfo.append("(");
        strInfo.append(DataAccountInfo.AccountType.getAccountType(Integer.parseInt(detail.getDataAccountInfo().getAccountType())).getText());
        strInfo.append(")");
        strInfo.append(detail.getDataAccountInfo().getAccountNumber().substring(0, 1)).append("******");
        strInfo.append("　");
        strInfo.append(detail.getDataAccountInfo().getAccountName());
   ...
   /**
     * ユーザ検索ボタンを取得する
    */
    private JButton getCollectButtonButton(final Integer customerID, final Integer slipNo)
    {
        JButton		collectButtonButton	=	new JButton();
        collectButtonButton.setBorderPainted(false);
        collectButtonButton.setContentAreaFilled(false);
        collectButtonButton.setIcon(new javax.swing.ImageIcon(getClass().getResource(
                        "/images/" + SystemInfo.getSkinPackage() + "/button/account/collect_bill_off.jpg")));
        collectButtonButton.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource(
                        "/images/" + SystemInfo.getSkinPackage() + "/button/account/collect_bill_on.jpg")));
        collectButtonButton.setSize(48, 25);
        collectButtonButton.addActionListener(new java.awt.event.ActionListener()
        {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                callCollectBill(customerID,  slipNo);
            }
        });
        return collectButtonButton;
        }
        
    private void callCollectBill(final Integer customerID, final Integer slipNo) {
        if(slipNo != null)
        {
            ...
            if(this.isDialog()) {
                SwingUtil.openAnchorDialog(this.parentFrame, true, cbp, "売掛回収", SwingUtil.ANCHOR_HCENTER | SwingUtil.ANCHOR_VCENTER);
            }else{
            ...
            BillsListPanel		blp	=	new BillsListPanel(customerID);
            blp.setOpener(this);
            this.setVisible(false);
    ...
    private class TableCellAlignRenderer extends SelectTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table,
            ...
            rCol = column;
            this.value = value;
            DataTransferResultDetail resultDetail = (DataTransferResultDetail) table.getValueAt(row, 4);
    ...
    */
        ...
        private DataTransferResultDetail detail = null;
        ...
        public void paint(Graphics g) {
            ...
            {
                if (detail.isShowCollectBill()) {
                    g.setColor(new Color( 242 , 220 , 219 ));
                    g.fillRect(0, 0, this.getWidth(), this.getHeight());
        } else {
    ...
    * @param customerID
    */
    private void getReservationToolTip(Integer customerID) {
        ...
        java.util.Date fromDate = currentDate.getTime();
        ...
        sql.append("   FROM data_sales AS ds ");
        sql.append("   WHERE ds.delete_date IS NULL ");
        sql.append("    AND ds.shop_id = t.shop_id ");
        sql.append("    AND ds.customer_id = t.customer_id ");
        sql.append("    AND ds.sales_date < date_trunc('day', date").append(SQLUtil.convertForSQL(fromDate)).append(") ");
        sql.append("    AND ds.sales_date IS NOT NULL ");
        sql.append("   ORDER BY ds.sales_date DESC, ");
        sql.append("    ds.slip_no DESC limit 1 ");
        ...
        sql.append("    drd.reservation_datetime , ");
        sql.append("    CASE WHEN drd.staff_id = 0 THEN NULL ELSE drd.staff_id END AS staff_id ,");
        sql.append("    ms.staff_no , ");
        sql.append("    ms.staff_name1 , ");
        sql.append("    ms.staff_name2 , ");
        sql.append("    CASE WHEN drd.bed_id = 0 THEN NULL ELSE drd.bed_id END AS bed_id , ");
        ...
        sql.append("                AND drd.delete_date is null ");
        sql.append("   LEFT OUTER JOIN mst_staff cms ");
        sql.append("                ON cms.staff_id = dr.staff_id ");
        sql.append("   LEFT OUTER JOIN mst_staff ms ");
        sql.append("                ON ms.staff_id = drd.staff_id ");
        sql.append("   LEFT OUTER JOIN mst_bed mb ");
        sql.append("                ON mb.bed_id = drd.bed_id ");
        sql.append("   LEFT OUTER JOIN mst_technic mt ");
        sql.append("                ON mt.technic_id = drd.technic_id ");
        sql.append("   LEFT OUTER JOIN mst_technic_class mtc ");
        sql.append("                ON mtc.technic_class_id = mt.technic_class_id ");
        sql.append("   WHERE ");
        sql.append("         dr.delete_date is null ");
        sql.append("         AND drd.reservation_datetime >= ").append(SQLUtil.convertForSQL(fromDate));
        sql.append("         AND drd.reservation_datetime < ").append(SQLUtil.convertForSQL(nextDate));
        ...
        sql.append("   LEFT OUTER JOIN mst_bed mb ");
        sql.append("                ON mb.bed_id = drd.bed_id ");
        sql.append("  LEFT OUTER JOIN mst_course c ");
        sql.append("                ON c.course_id = drd.technic_id ");
        sql.append("  LEFT OUTER JOIN mst_course_class cc ");
        ...
        String staffName = "[指名なし]";
        String bedName = "[指定なし]";
        String technicName = "";
        String strComment = "";
        String strTime = "";
        String strVisitDate = "";
        StringBuilder strReservationDateStrArray = new StringBuilder(1000);
        strReservationDateStrArray.append("");
        String birth = customer.getBirthdayString2() == null ? "" : customer.getBirthdayString2();
        birth += age.getText().equals("") ? "" : "　(" + age.getText() + "歳)";		
        String customerName = customer.getFullCustomerName();
        customerName += customer.getFullCustomerKana().equals("") ? "" : "（" + customer.getFullCustomerKana() + "）</td></tr>";
        String strPhoneNumber = cellularNumber.getText().equals("") ? phoneNumber.getText() : cellularNumber.getText();

        StringBuilder strTooltip = new StringBuilder(1000);
        strTooltip.append("<html><table>");
        strTooltip.append("<tr><th align='left'>顧客No.</th><td>").append(customerNo.getText()).append("</td></tr>");
        strTooltip.append("<tr><th align='left'>顧客名</th><td>").append(customerName).append("</td></tr>");
        strTooltip.append("<tr><th align='left'>誕生日</th><td>").append(birth).append("</td></tr>");

        try {
            ResultSetWrapper rs = SystemInfo.getConnection().executeQuery(sql.toString());
            while (rs.next()) {
                if (rs.getString("staff_name1") != null || rs.getString("staff_name2") != null) {
                    staffName = (rs.getString("staff_name1") == null ? "" : rs.getString("staff_name1"))
                            + (rs.getString("staff_name2") == null || rs.getString("staff_name2").equals("") ? "" : "　" + rs.getString("staff_name2"));
                }
                
                if (rs.getString("bed_name") != null) {
                    bedName = rs.getString("bed_name");
                }

                if (rs.getString("technic_name") != null) {
                    technicName = rs.getString("technic_name");
                }
                
                GregorianCalendar endTime = new GregorianCalendar();
                GregorianCalendar reservationDate = new GregorianCalendar();
                reservationDate.setTime(rs.getTimestamp("reservation_datetime"));
                endTime.setTime(reservationDate.getTime());
                endTime.add(endTime.MINUTE, rs.getInt("operation_time"));

                strComment = rs.getString("comment") == null ? "" : ReservationStatusPanel.formatHTMLString(ReservationStatusPanel.insertNewLineString(rs.getString("comment")));
                strTime = getFormatTime(reservationDate, rs.getTimestamp("reservation_datetime") ) + "～" + getFormatTime(endTime, rs.getTimestamp("reservation_datetime"));

                if (rs.getDate("last_visit_date") != null) {
                    strVisitDate = DateUtil.format(rs.getDate("last_visit_date"), "yyyy年M月d日 (E)");
                }

                String nextReservationDateStrArray = rs.getString("next_reservation_date");

                if(nextReservationDateStrArray != null) {
                    String str[] = nextReservationDateStrArray.split(",");
        ...
        strTooltip.append("<tr><th align='left'>スタッフ</th><td>").append(staffName).append("</td></tr>");
        strTooltip.append("<tr><th align='left'>施術台</th><td>").append(bedName).append("</td></tr>"); 
        strTooltip.append("<tr><th align='left'>技術</th><td>").append(technicName).append("</td></tr>");
        strTooltip.append("<tr><th align='left'>時間</th><td>").append(strTime).append("</td></tr>");				
        strTooltip.append("<tr><th align='left' valign='top'>予約メモ</th><td>").append(strComment).append("</td></tr>");                
        strTooltip.append("<tr><th align='left'>TEL</th><td>").append(strPhoneNumber).append("</td></tr>");
        strTooltip.append("<tr><th align='left'>前回来店日</th><td>").append(strVisitDate).append("</td></tr>");
        strTooltip.append("<tr><th align='left'>次回予約日</th><td>").append(strReservationDateStrArray.toString()).append("</td></tr>");

        boolean flag = true;
        for (MstCustomerFreeHeading cFH : mcfhs) {
            String freeHeadingClassName = cFH.getFreeHeadingClassName();
            String freeHeadingName = cFH.getFreeHeadingName();
             
            if(freeHeadingName != null)
            {
                if(flag == true)
                {
                    strTooltip.append("<tr><th align='left'>フリー項目</th><td> </td></tr>");
                    flag = false;
                }
                strTooltip.append("<tr><th colspan='2' align='left' valign='top'>").append(freeHeadingClassName).append("</th></tr>");
                strTooltip.append("<tr><td colspan='2' align='left'>").append(freeHeadingName).append("</td></tr>");
            }
        }
        
        TimeSchedule ts = new TimeSchedule();
        String rvSql = ts.getNextReservationSql(0, customerID);
        try
        {
            ResultSetWrapper rs = SystemInfo.getConnection().executeQuery(rvSql);
            int dataCount = 0;
            while (rs.next()) {
                if (dataCount == 0) {
                    strTooltip.append("<tr><th colspan='2' align='left'>【将来の予約情報】</th></tr>");
                }
                strTooltip.append("<tr><th align='left'>[予約日]</th><td>").append(DateUtil.format(rs.getDate("reservation_date"), "M月d日")).append("</td></tr>");
                strTooltip.append("<tr><th align='left'>[予約時間]</th><td>").append(rs.getString("reservation_time")).append("</td></tr>");
                strTooltip.append("<tr><th align='left' valign='top'>[予約メモ]</th><td>").append(ReservationStatusPanel.formatHTMLString
                                                        (ReservationStatusPanel.insertNewLineString(rs.getString("comment")))).append("</td></tr>");
                strTooltip.append("<tr><th colspan='2' align='left'></th></tr>");
        ...
        strTooltip.append("</table></html>");
        reservationTooltip.setToolTipText(strTooltip.toString());
        reservationTooltip.setVisible(true);
    }

    private String getFormatTime(Calendar cal, java.util.Date reservationDate) {
