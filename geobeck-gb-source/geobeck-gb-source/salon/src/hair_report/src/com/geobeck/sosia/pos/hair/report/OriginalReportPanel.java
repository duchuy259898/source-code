...
public class OriginalReportPanel extends com.geobeck.sosia.pos.swing.AbstractImagePanelEx {
    ...
    public static final String[] ORDER_ITEMS = {
            "R2（新規再来）", "R3", "R（既存再来）", "TO率（時間超過率）"
            , "客数", "指名数", "口コミ数（良い）", "口コミ数（悪い）"
            , "お直し数", "お直し率", "underfive 数量", "underfive【プラチナ割引】数量" , "単価", "売上"};
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(cmbOrderNo, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
