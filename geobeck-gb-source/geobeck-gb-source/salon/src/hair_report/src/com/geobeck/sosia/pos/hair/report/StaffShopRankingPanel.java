	    ...
	    // 僨乕僞僙僢僩
            ...
            jx.setValue(10,outRow+1,apAmount);
             if(flagCourse) {
                ...
                // 20171212 GB edit start #32913 儔儞僉儞僌丗巤弍扴摉偺僄僋僙儖弌椡偑偱偒側偄
                //媞扨壙
                //jx.setValue(15,outRow+1,chargAmount/totalChargCount);
                jx.setValue(15,outRow+1,customerPrice);
                //巤弍媞扨壙
                //jx.setValue(16,outRow+1,bedAmount/bedCount);
                jx.setValue(16,outRow+1,bedCustomerPrice);
                // 20171212 GB edit end #32913 儔儞僉儞僌丗巤弍扴摉偺僄僋僙儖弌椡偑偱偒側偄
             }else {
                ...
                jx.setValue(13,outRow+1,customerPrice);
                //巤弍媞扨壙
                //jx.setValue(14,outRow+1,bedAmount/bedCount);
                jx.setValue(14,outRow+1,bedCustomerPrice);
                // 20171212 GB edit end #32913 儔儞僉儞僌丗巤弍扴摉偺僄僋僙儖弌椡偑偱偒側偄
             }
                ...
                try {
                    ...
                    if(rdoValue.isSelected()) {
                        ...
                        if(flagCourse) {
                            ...
                            // 201712 GB edit end #34827 [GB撪懳墳][gb]儔儞僉儞僌丗揦曑僞僽偺悢帤偑偍偐偟偄
