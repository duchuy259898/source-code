 ...
 * @author IVS
 */
public class ReservationTransitionByWeekLogic extends ReportCustomize {
    ...
    public ReservationTransitionByWeekLogic(Integer year, Integer month, OutputType outputType, List<Map<String, String>> weeklyList) {
        this.year = year;
        this.month = month;
    ...
    public boolean report() {
        try {
            ...
            Logger.getLogger(ReservationTransitionByWeekLogic.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void fillData(List<Map<String, Object>> dataList) {
        String sheetName = this.outputType == OutputType.STAFF ? "èTä‘ó\ñÒêÑà⁄_ÉXÉ^ÉbÉt" : "èTä‘ó\ñÒêÑà⁄_ìXï‹";
        
        JExcelApi jx = new JExcelApi("èTÇ≈å©ÇÈó\ñÒêÑà⁄");
        jx.setTemplateFile("/reports/èTÇ≈å©ÇÈó\ñÒêÑà⁄.xls");
    ...
    public String getReportSQL() {
        ...
        sql.append("                                     WHERE mst.technic_id = ds.product_id ");
        sql.append("                                       AND mst.technic_id in (121, 122) ");
