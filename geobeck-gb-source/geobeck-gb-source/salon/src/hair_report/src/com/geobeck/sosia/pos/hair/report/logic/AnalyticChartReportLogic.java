...
public class AnalyticChartReportLogic {
    ...
    public boolean viewSalesReportByCustomerAttributeAnalyticChart(ReportParameterBean paramBean, String a) throws IOException, FileNotFoundException, SQLException {
        ...
        sql1.append( " from ");
        sql1.append( " (select extract(year from age('" + endDate + "', a.birthday))  as year, ");
        sql1.append( " case when extract(year from age('" + endDate + "', a.birthday)) <=14 then 1 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=19 then 2  ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=24 then 3 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=29 then 4 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=34 then 5 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=39 then 6 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=44 then 7 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=49 then 8 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=54 then 9 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) <=59 then 10 ");
        sql1.append( " when extract(year from age('" + endDate + "', a.birthday)) >=60 then 11 ");
        sql1.append( " else 12 ");
        sql1.append( " end ");
        ...
        sql2.append(" from ");
        sql2.append(" (select extract(year from age('" + endDate + "', a.birthday))  as year, ");
        sql2.append(" case when extract(year from age('" + endDate + "', a.birthday)) <=14 then 1 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=19 then 2  ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=24 then 3 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=29 then 4 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=34 then 5 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=39 then 6 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=44 then 7 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=49 then 8 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=54 then 9 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) <=59 then 10 ");
        sql2.append(" when extract(year from age('" + endDate + "', a.birthday)) >=60 then 11 ");
        sql2.append(" else 12 ");
        sql2.append(" end ");
