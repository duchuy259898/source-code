...
public class BillsListPanel extends com.geobeck.sosia.pos.swing.AbstractImagePanelEx
{
	...
	public void init()
	{
                //20170914 add start #26000 [GB内対応][gb]売掛回収画面：回収済タブの列幅調整
                initCollectsTableColumnSize();
                //20170914 add end #26000 [GB内対応][gb]売掛回収画面：回収済タブの列幅調整
     ...
     * 回収済テーブルの列幅設定
     */
    private void initCollectsTableColumnSize() {
        collects.getColumnModel().getColumn(0).setPreferredWidth(46);
        collects.getColumnModel().getColumn(1).setPreferredWidth(37);
        collects.getColumnModel().getColumn(2).setPreferredWidth(37);
        collects.getColumnModel().getColumn(3).setPreferredWidth(37);
        collects.getColumnModel().getColumn(4).setPreferredWidth(46);
        collects.getColumnModel().getColumn(5).setPreferredWidth(37);
        collects.getColumnModel().getColumn(6).setPreferredWidth(37);
        collects.getColumnModel().getColumn(7).setPreferredWidth(37);
        collects.getColumnModel().getColumn(8).setPreferredWidth(37);
        collects.getColumnModel().getColumn(9).setPreferredWidth(37);
        collects.getColumnModel().getColumn(10).setPreferredWidth(37);
        collects.getColumnModel().getColumn(11).setPreferredWidth(38);
        collects.getColumnModel().getColumn(12).setPreferredWidth(27);
        collects.getColumnModel().getColumn(13).setPreferredWidth(27);
    }
}
