...
public class CollectBillPanel extends com.geobeck.sosia.pos.swing.AbstractImagePanelEx
{
    ...
    private void initComponents() {
        ...
        collects.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "回収日", "レジ担当", "回収金額", "現金", "カード", "電子マネー", "金券・その他 ", "売掛残"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class
            };
            boolean[] canEdit = new boolean [] {
	...
	private void showCollectedBillData(BillsList bl)
	{
	    ...
	    for(CollectedBillData cbd : bl.getCollectedBills()) {
                ...
                //IVS_LVTU start edit 2017/09/06 #24806 [GB内対応][gb]回収処理画面 選択した伝票以外の支払履歴も表示される
                if((customerID1==customerID2) && (slipNo1==slipNo2))
                //if(customerID1==customerID2)
                //IVS_LVTU end edit 2017/09/06 #24806 [GB内対応][gb]回収処理画面 選択した伝票以外の支払履歴も表示される
                {
                    //IVS_LVTU start add 2017/09/13 #25663 [gb]回収処理画面：支払履歴に表示する項目を追加
                    ...
                    //IVS_LVTU end add 2017/09/13 #25663 [gb]回収処理画面：支払履歴に表示する項目を追加
                }
	    }
	}
