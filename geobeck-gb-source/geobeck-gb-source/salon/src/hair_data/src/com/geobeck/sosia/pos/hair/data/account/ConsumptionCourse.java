 ...
 * @author s_furukawa
 */
public class ConsumptionCourse implements Cloneable{
   ...
   public void setTaxRate(Double taxRate) {
    ...
    @Override
    public ConsumptionCourse clone() throws CloneNotSupportedException {
        return (ConsumptionCourse)super.clone();
    }
...
//            this.setBasePrice(rs.getLong("price"));
    ...
    public static String getSelectSQL(Integer shopId, Integer slipNo) {
        ...
        // IVS_LVTU edit 2019/09/25 #97064 [gb]SPOS増税対応
        sql.append("     ,COALESCE(dc.tax_rate, get_tax_rate(ds.sales_date)) as tax_rate");
        ...
        sql.append("                 on dc.shop_id = ds.shop_id and dc.slip_no = ds.slip_no");
        sql.append(" where");
