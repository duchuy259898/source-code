    ...
    private Boolean sendRegistRecessAPI(String login_id, int staff_id, Date schedule_date, 
        ...
        try{
            ...
            BufferedReader in = new BufferedReader(
                    // 20170815 nami start edit #21911 [GBì‡ëŒâû][gb]ãxåeìoò^âÊñ ÉRÉìÉ\Å[ÉãÉGÉâÅ[ëŒâû
                    //new InputStreamReader(con.getInputStream()));
                    new InputStreamReader(con.getInputStream(), "UTF-8"));
                    // 20170815 nami end edit #21911
            String inputLine;
            StringBuffer response = new StringBuffer();

            while ((inputLine = in.readLine()) != null) {
                // 20170815 nami start add  #21911 [GBì‡ëŒâû][gb]ãxåeìoò^âÊñ ÉRÉìÉ\Å[ÉãÉGÉâÅ[ëŒâû
                inputLine = (inputLine.indexOf("{")>-1)?inputLine.substring(inputLine.indexOf("{")):"";
                // 20170815 nami end add  #21911 [GBì‡ëŒâû][gb]ãxåeìoò^âÊñ ÉRÉìÉ\Å[ÉãÉGÉâÅ[ëŒâû
            ...
            try{
                ...
                String responseOb = response.toString();
                // 20170815 nami end edit #21911
