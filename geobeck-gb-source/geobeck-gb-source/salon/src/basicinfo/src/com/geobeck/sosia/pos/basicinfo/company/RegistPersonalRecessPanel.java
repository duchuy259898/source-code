...
//    private AbstractImagePanelEx parent;
    ...
    private boolean loadData() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // 201712 GB add start #33785 [GBì‡ëŒâû][gb]ãxåeìoò^âÊñ Ç…çÏê¨ì˙éûÅAçXêVì˙éûÇï\é¶
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm");
                insertDateLabel.setText(sdf.format(rs.getTimestamp("insert_date")));
                updateDateLabel.setText(sdf.format(rs.getTimestamp("update_date")));
                // 201712 GB add start #33785 [GBì‡ëŒâû][gb]ãxåeìoò^âÊñ Ç…çÏê¨ì˙éûÅAçXêVì˙éûÇï\é¶
            }
            rs.close();
    ...
    private RegistPersonalRecessPanel( MstShop shop, Date targetDate) {
        ...
        // 201712 GB edit start #33785 [GBì‡ëŒâû][gb]ãxåeìoò^âÊñ Ç…çÏê¨ì˙éûÅAçXêVì˙éûÇï\é¶
        //this.setSize(300, 250);
        this.setSize(333, 266);
        
        insertDateLabel.setText("");
        updateDateLabel.setText("");
        // 201712 GB edit end #33785 [GBì‡ëŒâû][gb]ãxåeìoò^âÊñ Ç…çÏê¨ì˙éûÅAçXêVì˙éûÇï\é¶
...
//                }
    ...
    private void initComponents() {
        ...
        insertLabel.setText("ìoò^ì˙éû");

        updateLabel.setText("çXêVì˙éû");

        insertDateLabel.setText("2017/12/21 05:45");

        updateDateLabel.setText("2017/12/21 05:45");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(insertDateLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(updateLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(updateDateLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(noteScrollPane1)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(memoLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(noteScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
