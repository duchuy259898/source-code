...
public class MstAutoMailSettingDetailPanel extends com.geobeck.sosia.pos.swing.AbstractImagePanelEx implements  SearchHairProductOpener
{
	public MstAutoMailSettingDetailPanel(MstAutoMailSetting ams)
	{
	    ...
	    this.setSize(800, 650);
            ...
            //IVS_LVTu start add 2017/09/27 #26788 [gb]自動メール設定：機能していない項目を非表示にする
            technicKey.setVisible(false);
            itemKey.setVisible(false);
            courseKey.setVisible(false);
            //IVS_LVTu end add 2017/02/27 #26788 [gb]自動メール設定：機能していない項目を非表示にする
        }
    ...
    private void initComponents() {
        ...
        keyPanelLayout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, customerNameKey, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 92, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
